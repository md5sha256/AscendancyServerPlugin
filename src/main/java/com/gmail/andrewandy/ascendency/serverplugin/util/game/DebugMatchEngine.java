...
public class DebugMatchEngine implements GameEngine {
    ...
    @Override public void rejoin(final UUID player) throws IllegalArgumentException {

    }

    @Override public Optional<? extends GamePlayer> getGamePlayerOf(final UUID player) {
